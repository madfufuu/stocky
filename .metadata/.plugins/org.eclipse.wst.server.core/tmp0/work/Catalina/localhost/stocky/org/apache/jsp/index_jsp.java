 ...
 * Generated at: 2019-11-29 20:12:27 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t</nav>\n");
      out.write("\n");
      out.write("\t<form method=\"post\" action=\"http://localhost:8180/webApplication/LoginCheck\">\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<div id=\"signin-form-card\" class=\"card\">\n");
      out.write("\t\t\t\t\t<article class=\"card-body\">\n");
      out.write("\t\t\t\t\t\t<a href=\"member.jsp\" class=\"btn btn-outline-primary\">Already Logged in?</a>\n");
      out.write("\t\t\t\t\t\t<a href=\"signup.jsp\" class=\"float-right btn btn-outline-primary\">Sign up</a>\n");
      out.write("\t\t\t\t\t\t<h4 class=\"card-title mb-4 mt-4\">Sign in</h4>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Email</label>\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"email\" class=\"form-control\" placeholder=\"Email\" type=\"email\" required>\n");
      out.write("\t\t\t\t\t\t\t</div> <!-- form-group// -->\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<a class=\"float-right\" href=\"#\">Forgot password?</a>\n");
      out.write("\t\t\t\t\t\t\t\t<label>Password</label>\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" placeholder=\"******\" type=\"password\" name=\"password\" required>\n");
      out.write("\t\t\t\t\t\t\t</div> <!-- form-group// --> \n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\"> \n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"checkbox\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\"> Save password </label>\n");
